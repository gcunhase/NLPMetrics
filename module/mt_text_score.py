...
class TextScore:
    ...
    def score_multiple_from_file(self, ref_file, hyp_file, scores_file, score_type=BLEU_NAME, average_prec="corpus"):
        ...
        if GLEU_NAME in score_type:
            scores.append(self.score_one_from_file(ref_file, hyp_file, scores_file, score_type=GLEU_NAME, average_prec=average_prec))
        ...
        if METEOR_NAME in score_type:
            scores.append(self.score_one_from_file(ref_file, hyp_file, scores_file, score_type=METEOR_NAME, average_prec=average_prec))
    ...
    def score_one_from_file(self, ref_file, hyp_file, scores_file, score_type="BLEU", average_prec="corpus"):
        ...
        :param score_type: BLEU, GLEU, WER, METEOR
        ...
        for i in range(0, num_sentences):
            if len(reference[i].strip()) != 0 or len(hypothesis[i].strip()) != 0:
                # TODO: multiple sentences in one line
        ...
        if "corpus" in average_prec and (WER_NAME not in score_type) and (METEOR_NAME not in score_type) and\
    ...
    def corpus_score(self, list_of_references, hypotheses, score_type="BLEU"):
        ...
        elif GLEU_NAME in score_type:  # "GLEU"
    ...
    def sentence_average_score(self, list_of_references, hypotheses, score_type="BLEU"):
        ...
        elif METEOR_NAME in score_type:
            for ref, hyp in zip(list_of_references, hypotheses):
                sent_average_score += self.meteor_score(ref[0], hyp)
    ...
    def meteor_score(self, ref, hyp):
        # TODO: Meteor metric
        print("TODO: METEOR text score")
        return 0.0

    def cider_score(self, ref, hyp):
        # TODO: CIDEr metric
        print("TODO: CIDEr text score")
        return 0.0